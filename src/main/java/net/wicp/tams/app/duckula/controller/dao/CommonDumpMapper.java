...
public interface CommonDumpMapper extends BaseMapper<CommonDump> {
	...
	@Insert({ "insert into common_dump (id, name, ", "rule, version_id, ", "deploy_id, user_id, ",
			"middleware_id, instance_id, ", "where_sql, attr_config)",
			...
			"#{whereSql,jdbcType=VARCHAR}, #{attrConfig,jdbcType=VARCHAR})" })
	 ...
	 * @mbg.generated
	 */
	@Select({ "select", "id, name, rule, version_id, deploy_id, user_id, middleware_id, instance_id, ",
			"where_sql, attr_config", "from common_dump", "where id = #{id,jdbcType=BIGINT}" })
	...
	@Update({ "update common_dump", "set name = #{name,jdbcType=VARCHAR},", "rule = #{rule,jdbcType=VARCHAR},",
			...
			"instance_id = #{instanceId,jdbcType=BIGINT},", "where_sql = #{whereSql,jdbcType=VARCHAR},",
