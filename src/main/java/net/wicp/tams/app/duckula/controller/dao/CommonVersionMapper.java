...
public interface CommonVersionMapper extends BaseMapper<CommonVersion> {
	 ...
	 * @mbg.generated
	 */
	@Insert({ "insert into common_version (id, main_version, ", "main_path, data_version, ", "data_path, image_group, ",
			...
			"#{dataPath,jdbcType=VARCHAR}, #{imageGroup,jdbcType=VARCHAR}, ",
	 ...
	 * @mbg.generated
	 */
	@Select({ "select", "id, main_version, main_path, data_version, data_path, image_group, author, update_time, ",
			"readme", "from common_version", "where id = #{id,jdbcType=BIGINT}" })
	...
	@Update({ "update common_version", "set main_version = #{mainVersion,jdbcType=VARCHAR},",
			...
			"data_path = #{dataPath,jdbcType=VARCHAR},", "image_group = #{imageGroup,jdbcType=VARCHAR},",
